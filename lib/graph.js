...
exports.graphCreator = () => {
  ...
  return {
    ...
    get: (from/*: string */, maxTime/*: number */, maxLines/*: number */, extra/*: Object */, options/*: GraphOptions */)/*: {[string]: ReachableNode } */ => {
        ...
        traverse.batch((el) => {
          ...
          mapLineToNodes.get(el.line).forEach((to) => {
            ...
            if (totalTime <= maxTime) {
              ...
              paths.add(to, totalTime, traversedLines, extra);
